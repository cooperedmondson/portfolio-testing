  ...
  return (
    <div className='main-three'>
      ...
      <div className='line-arrow'>
        <svg width="831" height="229" viewBox="0 0 831 229" fill="none" xmlns="http://www.w3.org/2000/svg" className='bg-transparent'>
        ...
        <div className='arrow'>
          <svg width="69" height="56" viewBox="0 0 69 56" fill="none" xmlns="http://www.w3.org/2000/svg" className='bg-transparent'>
